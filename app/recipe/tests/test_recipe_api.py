...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_partial_update(self):
        ...
        original_link ='https://exampe.com/recipe.pdf'
    ...
    def test_update_user_returns_error(self):
        ...
        new_user = create_user(email='example2@example.com', password="1234password")
        recipe = create_recipe(user=self.user)
    ...
    def test_create_recipe_with_new_ingredients(self):
        """Test creating ingredients with new ingredients"""
    ...
    def test_create_recipe_with_existing_ingredient(self):
        ...
        payload = {
            ...
            'time_minutes': 60,
            'price': Decimal('5.25'),
            'ingredients':[{'name': 'Salt'}, {'name': 'Fish'}],
        }
    ...
    def test_create_ingredient_on_update(self):
        ...
        self.assertEqual(res.status_code, status.HTTP_200_OK)
        new_ingredient = Ingredient.objects.get(user=self.user, name='Orange')
        self.assertIn(new_ingredient, recipe.ingredients.all())

    def test_update_recipe_assign_ingredient(self):
        """Test assigning an existing ingredient when updating a recipe"""
        ingredient_sugar = Ingredient.objects.create(user=self.user, name='Sugar')
        recipe = create_recipe(user=self.user)
        recipe.ingredients.add(ingredient_sugar)
        ...
        self.assertNotIn(ingredient_sugar, recipe.ingredients.all())
    ...
    def test_filter_by_tags(self):
        ...
        r1=create_recipe(user=self.user, title="Tagine maroccaine")
        r2=create_recipe(user=self.user, title='Paella')
    ...
    def test_filter_by_ingredients(self):
        ...
        in2 = Ingredient.objects.create(user=self.user, name='Fish')
        r1.ingredients.add(in1)
        r2.ingredients.add(in2)
        r3= create_recipe(user=self.user, title='Tortilla')
